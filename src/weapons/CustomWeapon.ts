...
export const draftPistol:CustomWeapon={
  id:'draft-pistol-default',category:'pistol',color:weaponCategories.pistol.color,scale:.44,gripAnchor:{x:.38,y:.68},muzzleAnchor:{x:.96,y:.3},drawing:[
    {width:.042,points:[{x:.07,y:.24},{x:.9,y:.23},{x:.97,y:.31},{x:.91,y:.38},{x:.51,y:.4},{x:.45,y:.5},{x:.43,y:.86},{x:.25,y:.88},{x:.28,y:.48},{x:.08,y:.43},{x:.07,y:.24}]},
    {width:.026,points:[{x:.12,y:.29},{x:.86,y:.28},{x:.92,y:.32}]},
    {width:.023,points:[{x:.3,y:.49},{x:.47,y:.5},{x:.39,y:.6},{x:.29,y:.58}]},
    {width:.02,points:[{x:.23,y:.35},{x:.72,y:.34}]},
  ],
};

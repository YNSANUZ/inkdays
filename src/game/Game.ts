...
export class Game {
  ...
  constructor(app:HTMLElement) {
    ...
    this.world=new World(this.scene);this.bossTeaser=new BossTeaser();this.scene.add(this.bossTeaser.root,this.player.avatar.root,this.camera.camera);this.viewWeapon=new FirstPersonWeapon(this.camera.camera);this.enemies=new Enemies(this.scene,this.world);this.effects=new Effects(this.scene);this.ui=new UI(app);

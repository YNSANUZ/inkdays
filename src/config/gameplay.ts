export const C = {
  ...
  boss: { name: 'O COLOSSO', health: 1200, healthGrowth: 300, partyGrowth: .45, speed: 2.15, damage: 30, attackRange: 2.25, attackCooldown: 1.45, radius: .9, reward: 500, scale: 2.15 },

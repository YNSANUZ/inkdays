...
export class UI {
  ...
  menu(start:()=>void,settings:()=>void) {
    ...
    this.overlay.innerHTML=`<div class="home-content"><div class="edition"><span></span> UM JOGO DE SOBREVIVÊNCIA EM TINTA</div><h1>INKDAYS<span class="logo-dot">.</span></h1><h2>SOBREVIVA MAIS UM DIA.</h2><p>O mundo é uma folha em branco.<br>A noite tem outros planos.</p><button class="primary" id="online">JOGAR ONLINE · 2 PLAYERS <span>↗</span></button><button class="secondary" id="play">JOGAR SOZINHO</button><button class="secondary" id="settings">CONFIGURAÇÕES <span>⚙</span></button><button class="install-button" id="install">↓ INSTALE AQUI</button><div class="home-note"><i></i> Entre com um amigo. Sobrevivam juntos.</div><div class="home-controls">WASD para explorar &nbsp;·&nbsp; Mouse para mirar e atirar</div></div><div class="map-caption"><span>01 / VALE DO PAPEL</span><p>Antes da noite,<br>aprenda os caminhos.</p><i>↓</i></div>`;

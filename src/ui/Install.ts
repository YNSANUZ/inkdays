...
export async function installGame(){
  ...
  dialog.innerHTML='<h2>INKDAYS no seu aparelho</h2><p></p><p>Depois do primeiro carregamento completo, o jogo fica disponível offline. Quando houver uma atualização, basta abrir o aplicativo conectado à internet.</p><form method="dialog"><button class="primary">ENTENDI</button></form>';

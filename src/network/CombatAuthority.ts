...
export class CombatAuthority {
  ...
  restart(id:string){
    ...
    for(const p of this.players.values()){
      ...
      p.weapon=new Pistol();p.input.command=neutral();p.age=Infinity;p.protection=C.player.spawnProtection;p.kills=0;p.money=0;p.shotPending=null;
    }
    return true;
  }
  revive(id:string){

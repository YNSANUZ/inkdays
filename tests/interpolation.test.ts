...
import {AngleInterpolationBuffer,InterpolationBuffer,interpolationTick} from '../src/network/Interpolation';
describe('interpolação remota',()=>{
  ...
  it('calcula o tick realmente apresentado sem extrapolar o estado mais novo',()=>{expect(interpolationTick(30,1000,1050)).toBe(27);expect(interpolationTick(30,1000,1200)).toBe(30);});
});

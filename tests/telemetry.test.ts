...
describe('telemetria de snapshots',()=>{
  it('ignora duplicatas e aceita reordenação dentro da janela',()=>{const t=new SnapshotTelemetry();for(const [tick,arrival] of [[3,50],[6,100],[12,200],[9,210],[12,220],[15,250],[18,300]])t.observe(tick,arrival);expect(t.lossPercent).toBe(0);expect(t.jitter).toBeLessThan(1);});
